...
export class ProductsController {
  ...
  async findAll(@Query() paginationDto: PaginationDto, @Query() filterDto: ProductFilterDto) {
  ...
  @ApiResponse({ status: 200, description: 'Products retrieved successfully' })
  async findAllAdmin(@Query() paginationDto: PaginationDto, @Query() filterDto: ProductFilterDto) {
