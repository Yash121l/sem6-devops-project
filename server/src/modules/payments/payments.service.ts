...
export class PaymentsService {
  ...
  async process(paymentId: string, processDto: ProcessPaymentDto): Promise<Payment> {
    ...
    try {
      ...
      if (success) {
        ...
        await this.ordersService.updatePaymentStatus(payment.orderId, PaymentStatus.COMPLETED);
  ...
  async handleWebhook(provider: string, _payload: Record<string, unknown>): Promise<void> {
