...
export class PaymentsController {
  ...
  async process(@Param('id', ParseUUIDPipe) id: string, @Body() processDto: ProcessPaymentDto) {
  ...
  async refund(@Param('id', ParseUUIDPipe) id: string, @Body() refundDto: RefundPaymentDto) {
  ...
  async handleWebhook(
    ...
    @Headers('stripe-signature') _stripeSignature: string,
  ) {
